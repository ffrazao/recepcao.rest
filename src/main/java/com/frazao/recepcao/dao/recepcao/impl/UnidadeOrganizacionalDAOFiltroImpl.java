...
import com.frazao.recepcao.dao.recepcao.UnidadeOrganizacionalDAOFiltro;
...
public class UnidadeOrganizacionalDAOFiltroImpl implements UnidadeOrganizacionalDAOFiltro {
	...
	@Override
	public Collection<UnidadeOrganizacional> filtrar(UnidadeOrganizacionalFiltroDTO f) {

		StringBuilder sql = new StringBuilder();
		sql.append("SELECT em.*").append("\n");
		sql.append("FROM   recepcao.unidade_organizacional as em").append("\n");
		...
		Query query = entityManager.createNativeQuery(sql.toString(), UnidadeOrganizacional.class);
		// if (StringUtils.isNotBlank(f.getCpfCnpj())) {
