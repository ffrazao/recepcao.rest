...
import com.frazao.recepcao.dao.recepcao.FuncionarioDAOFiltro;
...
public class FuncionarioDAOFiltroImpl implements FuncionarioDAOFiltro {
	...
	@Override
	public Collection<Funcionario> filtrar(FuncionarioFiltroDTO f) {

		StringBuilder sql = new StringBuilder();
		sql.append("SELECT em.*").append("\n");
		sql.append("FROM   recepcao.funcionario as em").append("\n");
